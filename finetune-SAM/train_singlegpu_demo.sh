...
dataset_name="TrainDataset"  # Assuming you set this if it's dynamic
...
img_folder="./union"  # Assuming this is the folder where images are stored
train_img_list="${img_folder}/${dataset_name}/train_labels.csv"
val_img_list="${img_folder}/${dataset_name}/val_labels.csv"
