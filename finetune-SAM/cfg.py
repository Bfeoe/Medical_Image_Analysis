...
def parse_args():    
    ...
    parser.add_argument('-img_folder', type=str, default='./union/', help='the folder putting images')
    parser.add_argument('-mask_folder', type=str, default='./union/', help='the folder putting masks')
    parser.add_argument('-train_img_list', type=str, default='./union/TrainDataset/train_labels.csv')
    parser.add_argument('-val_img_list', type=str,default='./union/TrainDataset/val_labels.csv')
